...
<head>
    ...
    <style>
        ...
        .kr-mail-icon.ok { background: rgba(111,126,219,0.15); color: #6f7edb; }
        .kr-mail-icon.err { background: rgba(255,115,97,0.15); color: #ff7361; }
        .kr-mail-title {
            font-size: 1.9rem;
            font-weight: 800;
...
<?php
    ...
    if ($ok) {
        ...
        echo '<p class="kr-mail-note" style="margin-top:20px;">Serás redirigido automáticamente en unos segundos...</p>';
        echo '<script>setTimeout(function(){ window.location.href="/v3/index.html"; }, 4000);</script>';
    } else {
        ...
        echo '<p class="kr-mail-sub">Ocurrió un error al enviar tu mensaje. Por favor escribinos directamente a <a href="mailto:info@asesoriacontablekr.com.ar" style="color:#6f7edb;">info@asesoriacontablekr.com.ar</a></p>';
        echo '<a href="contacto.html" class="kr-btn-primary" style="margin:0 auto;">Volver al formulario</a>';
        echo '<script>setTimeout(function(){ window.location.href="/v3/contacto.html"; }, 6000);</script>';
    }
?>
    </div>
</div>
